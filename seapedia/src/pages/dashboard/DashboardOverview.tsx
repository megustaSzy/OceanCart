    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-2">
          Selamat datang kembali di Dashboard {user?.activeRole}.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-3xl p-6 text-white shadow-xl shadow-blue-500/30">
          ...
          <Link
            to="/dashboard/wallet"
            className="inline-flex items-center text-sm font-bold text-white hover:text-blue-100 transition-colors"
          >
          ...
          <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm flex flex-col justify-between">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-medium text-gray-500">
                Total{" "}
                {user?.activeRole === "SELLER" ? "Pesanan Masuk" : "Pesanan"}
              </h3>
        ...
        {user?.activeRole === "SELLER" && (
          <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm flex flex-col justify-between">
            ...
            <Link
              ...
              className="bg-indigo-600 text-white font-bold py-3 rounded-xl text-center hover:bg-indigo-700 transition-colors shadow-md shadow-indigo-500/20"
            >
              Lihat Produk
            </Link>
          </div>
        ...
        {user?.activeRole === "DRIVER" && (
          <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm flex flex-col justify-between">
            ...
            <Link
              to="/dashboard/jobs"
              className="bg-cyan-600 text-white font-bold py-3 rounded-xl text-center hover:bg-cyan-700 transition-colors shadow-md shadow-cyan-500/20"
            >
              Lihat Pekerjaan
            </Link>
          </div>
